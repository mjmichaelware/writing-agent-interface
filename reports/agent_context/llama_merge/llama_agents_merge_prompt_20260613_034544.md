...
- Merge AGENTS.md, AGENTS_README.md, AGENT_READ_CONTEXT_INDEX.md, and the canonical staged context index.
...
--- CURRENT AGENT_READ_CONTEXT_INDEX.md ---
