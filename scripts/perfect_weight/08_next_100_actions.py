...
"Keep docs/agent_context/indexes/AGENTS_README.md as a short pointer to AGENTS.md.",
"Preserve docs/agent_context/indexes/AGENT_READ_CONTEXT_INDEX.md as the numbered-source map.",
